...
from nodes import parse_node, score_node, planner_node, drafter_node, route_after_planning
...
graph.add_conditional_edges("plan", route_after_planning, {"draft": "draft", "end": END})
